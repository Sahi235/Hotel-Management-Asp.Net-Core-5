...
namespace DataAccess.Cryptoghraphy
{
    public class SecretStore : ISecretStore
    {
        ...
        {
            return saltName switch
            {
                CryptoStoreSimulator.KEYNAME_USERNAME =>
                    "4129F57F34DE621C41931AB3EC0E31B1EA742E8A454B1570F47AB77C538EEA9D",
                CryptoStoreSimulator.KEYNAME_EMAIL =>
                    "FFA5954D477572D8A07A89D61A983AED953680FCC093FDDF4FFCF4FBD9993382",
                CryptoStoreSimulator.KEYNAME_NORMALIZED_USERNAME =>
                    "98D0AA51A00787B709FC8D7D1B5038DFE57CB531AF83DD53FF0CE531D9638EBD",
                CryptoStoreSimulator.KEYNAME_NORMALIZED_EMAIL =>
                    "58AED901C7DC072F998FED243A95E89A77F3890EE9D1DC33C6B2DAB9983A34B5",
                CryptoStoreSimulator.KEYNAME_PHONE =>
                    "1969583C833B246BE394176FDA7A9E21B2A1F652A46B89CBBCD1CCD4DF4FC4BB",
                //For verification only!
                "EMPTY_SALT" => "",
                _ => throw new NotImplementedException($"Cannot find salt for: {saltName}")
            };
        }
    }
}
