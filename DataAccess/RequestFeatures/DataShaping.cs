...
{
    public class DataShaping<T> : IDataShaping<T>
    {
        ...
        public IEnumerable<ExpandoObject> ShapeData(IEnumerable<T> entities, string filedNames)
        {
            var requiredProperties = GetRequiredProperties(filedNames);
